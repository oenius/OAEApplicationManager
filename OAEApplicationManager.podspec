...
Pod::Spec.new do |s|
  ...
  s.description  = "cooool application portal."

  s.homepage     = "http://EXAMPLE/OAEApplicationManager"
  ...
  s.author             = { "" => "longban.zy@antfin.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/OAEApplicationManager.git", :tag => "#{s.version}" }
